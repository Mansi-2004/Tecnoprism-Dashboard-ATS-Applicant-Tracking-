...
import { Bell, Search, X, User } from "lucide-react"; // Added User for default profile
  ...
  const syncUserProfile = async () => {
    try {
      ...
      if (user) {
        ...
        // Handle Preferences
        if (user.preferences) {
          const { theme, compact_mode } = user.preferences;
          ...
          // Compact Mode
          document.body.classList.toggle("compact-mode", compact_mode);
        }
