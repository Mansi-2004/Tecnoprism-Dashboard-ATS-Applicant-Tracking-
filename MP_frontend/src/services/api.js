...
export const transformApplicationToApplicant = (app) => {
    ...
    // Format date with exact time (ensuring UTC strings are treated correctly)
    ...
    return {
        ...
        resumeUrl: app.resume_file_path ? `http://localhost:8000/${app.resume_file_path.replace(/\\/g, '/')}` : null,
        matchDetails: {
