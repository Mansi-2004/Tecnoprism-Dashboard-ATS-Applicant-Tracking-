...
export default function SettingsPage() {
  const [preferences, setPreferences] = useState({
    theme: localStorage.getItem("ats-theme") || "light",
    language: "en",
    timezone: "ist",
  ...
  const [profile, setProfile] = useState({
    name: localStorage.getItem("ats-user-name") || "User",
    email: localStorage.getItem("ats-user-email") || "",
    phone: "",
    location: "",
    company: "",
    domain: "",
  ...
  const [userPhoto, setUserPhoto] = useState(localStorage.getItem("ats-user-photo") || null);
  ...
  useEffect(() => {
    ...
    localStorage.setItem("ats-theme", preferences.theme);
  }, [preferences.theme]);
      ...
      try {
        ...
        if (userData) {
          ...
          if (userData.profile_photo) {
            const photoUrl = `http://localhost:8000/${userData.profile_photo.replace(/\\/g, '/')}`;
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Switch
                checked={notifications.new_applicants}
                onCheckedChange={(checked) => handleNotificationChange("new_applicants", checked)}
              />
            </div>
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => handleNotificationChange("status_updates", checked)}
              />
            </div>
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
          ...
          <CardContent className="space-y-4">
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  <Sun className={`h-6 w-6 mx-auto mb-2 ${preferences.theme === "light" ? "text-primary" : "text-muted-foreground"}`} />
                  <p className={`text-sm font-medium ${preferences.theme === "light" ? "text-primary" : "text-muted-foreground"}`}>
                    Light Mode
                  </p>
                </button>
                <button
                ...
                >
                  <Moon className={`h-6 w-6 mx-auto mb-2 ${preferences.theme === "dark" ? "text-primary" : "text-muted-foreground"}`} />
                  <p className={`text-sm font-medium ${preferences.theme === "dark" ? "text-primary" : "text-muted-foreground"}`}>
                    Dark Mode
                  </p>
                </button>
              </div>
